...
export default function SwitchToggle({status, onToggle}:SwitchToggleProps){
    return <div className={twMerge(" cursor-pointer transition inline-block w-[55px] h-[30px] rounded-full", (status==undefined || status==true) ? "bg-blue-500": "bg-gray-800" )} onClick={onToggle}>
